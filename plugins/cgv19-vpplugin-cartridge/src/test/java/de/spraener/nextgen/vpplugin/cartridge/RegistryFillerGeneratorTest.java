...
import de.spraener.nextgen.vpplugin.cartridge.OOModelMother;

public class RegistryFillerGeneratorTest {
    private RegistryFillerGenerator uut = new RegistryFillerGenerator();
    ...
    void setup() {
        ...
        OOModelBuilder.createMClass(pkg, "MyTestClass",
                  c -> OOModelBuilder.createStereotype(c, "ExporterRegistryFiller")
        );
