...
public class CreateExporterRegistryFillerTransformationTest {

    private OOModel model;
    private ModelElement testME;
    private CreateExporterRegistryFillerTransformation uut = new CreateExporterRegistryFillerTransformation();
