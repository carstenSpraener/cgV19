...
import de.spraener.nxtgen.ice.OOModelMother;

public class DockerComposeYmlGeneratorTest {
    private DockerComposeYmlGenerator uut = new DockerComposeYmlGenerator();
    ...
    void setup() {
        ...
        OOModelBuilder.createMClass(pkg, "MyTestClass",
                  c -> OOModelBuilder.createStereotype(c, "DockerApplication")
        );
