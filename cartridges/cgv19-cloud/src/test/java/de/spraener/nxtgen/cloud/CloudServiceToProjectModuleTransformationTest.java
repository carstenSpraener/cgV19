...
public class CloudServiceToProjectModuleTransformationTest {

    private OOModel model;
    private ModelElement testME;
    private CloudServiceToProjectModuleTransformation uut = new CloudServiceToProjectModuleTransformation();
