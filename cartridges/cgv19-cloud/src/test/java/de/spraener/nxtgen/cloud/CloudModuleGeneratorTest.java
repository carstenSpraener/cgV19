...
import de.spraener.nxtgen.cloud.OOModelMother;

public class CloudModuleGeneratorTest {
    private CloudModuleGenerator uut = new CloudModuleGenerator();
    ...
    void setup() {
        ...
        OOModelBuilder.createMClass(pkg, "MyTestClass",
                  c -> OOModelBuilder.createStereotype(c, "CloudModule")
        );
