...
public class CloudModuleRequiredDatabaseTransformationTest {

    private OOModel model;
    private ModelElement testME;
    private CloudModuleRequiredDatabaseTransformation uut = new CloudModuleRequiredDatabaseTransformation();
