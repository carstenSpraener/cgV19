...
import de.spraener.nxtgen.javalin.OOModelMother;

public class JavaLinHandlerBaseGeneratorTest {
    private JavaLinHandlerBaseGenerator uut = new JavaLinHandlerBaseGenerator();
    ...
    void setup() {
        ...
        OOModelBuilder.createMClass(pkg, "MyTestClass",
                  c -> OOModelBuilder.createStereotype(c, "RequestHandlerBase")
        );
