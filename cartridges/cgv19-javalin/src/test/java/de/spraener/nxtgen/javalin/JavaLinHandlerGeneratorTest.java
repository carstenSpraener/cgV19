...
public class JavaLinHandlerGeneratorTest {
    private JavaLinHandlerGenerator uut = new JavaLinHandlerGenerator();
    ...
    void setup() {
        ...
        OOModelBuilder.createMClass(pkg, "MyTestClass",
                  c -> OOModelBuilder.createStereotype(c, "RequestHandler")
        );
