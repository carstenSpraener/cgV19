...
public class FilamentRelationManagerGeneratorTest {
    private FilamentRelationManagerGenerator uut = new FilamentRelationManagerGenerator();
    ...
    void setup() {
        ...
        OOModelBuilder.createMClass(pkg, "MyTestClass",
                  c -> OOModelBuilder.createStereotype(c, "FilamentRelationManager")
        );
