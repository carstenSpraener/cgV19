...
public class FilamentResourceGeneratorTest {
    private FilamentResourceGenerator uut = new FilamentResourceGenerator();
    ...
    void setup() {
        ...
        OOModelBuilder.createMClass(pkg, "MyTestClass",
                  c -> OOModelBuilder.createStereotype(c, "FilamentResource")
        );
