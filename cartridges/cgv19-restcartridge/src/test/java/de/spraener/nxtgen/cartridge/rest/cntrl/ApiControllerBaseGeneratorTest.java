...
import de.spraener.nxtgen.cartridge.rest.OOModelMother;

public class ApiControllerBaseGeneratorTest {
    private ApiControllerBaseGenerator uut = new ApiControllerBaseGenerator();
    ...
    void setup() {
        ...
        OOModelBuilder.createMClass(pkg, "MyTestClass",
                  c -> OOModelBuilder.createStereotype(c, "ApiRessource")
        );
