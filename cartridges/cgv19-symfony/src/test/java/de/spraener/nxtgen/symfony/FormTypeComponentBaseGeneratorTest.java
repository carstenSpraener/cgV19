...
public class FormTypeComponentBaseGeneratorTest {
    private FormTypeComponentBaseGenerator uut = new FormTypeComponentBaseGenerator();
    ...
    void setup() {
        ...
        OOModelBuilder.createMClass(pkg, "MyTestClass",
                  c -> OOModelBuilder.createStereotype(c, "FormTypeComponentBase")
        );
