...
public class ControllerServiceTraitGeneratorTest {
    private ControllerServiceTraitGenerator uut = new ControllerServiceTraitGenerator();
    ...
    void setup() {
        ...
        OOModelBuilder.createMClass(pkg, "MyTestClass",
                  c -> OOModelBuilder.createStereotype(c, "PhpCntrlServiceTrait")
        );
