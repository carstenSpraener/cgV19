...
package de.spraener.nxtgen.symfony.controller;
...
import de.spraener.nxtgen.symfony.OOModelMother;

public class PhpControllerBaseGeneratorTest {
    private PhpControllerBaseGenerator uut = new PhpControllerBaseGenerator();
    ...
    void setup() {
        ...
        OOModelBuilder.createMClass(pkg, "MyTestClass",
                  c -> OOModelBuilder.createStereotype(c, "RESTControllerBase")
        );
