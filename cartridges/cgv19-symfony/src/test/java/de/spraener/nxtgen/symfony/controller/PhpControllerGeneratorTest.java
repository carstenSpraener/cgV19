...
public class PhpControllerGeneratorTest {
    private PhpControllerGenerator uut = new PhpControllerGenerator();
    ...
    void setup() {
        ...
        OOModelBuilder.createMClass(pkg, "MyTestClass",
                  c -> OOModelBuilder.createStereotype(c, "RESTController")
        );
