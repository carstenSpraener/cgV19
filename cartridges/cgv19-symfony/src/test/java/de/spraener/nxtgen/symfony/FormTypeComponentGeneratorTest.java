...
public class FormTypeComponentGeneratorTest {
    private FormTypeComponentGenerator uut = new FormTypeComponentGenerator();
    ...
    void setup() {
        ...
        OOModelBuilder.createMClass(pkg, "MyTestClass",
                  c -> OOModelBuilder.createStereotype(c, "FormTypeComponent")
        );
